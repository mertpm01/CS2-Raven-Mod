...
namespace updater {
	...
	namespace offsets {
		...
		inline std::ptrdiff_t dwGlobalVars = 0x205A580; // Global vars for current time
		...
		inline std::ptrdiff_t m_vecVelocity = 0x438; // 1080 decimal - projectile velocity
		inline std::ptrdiff_t m_entitySpottedState = 0x0; // EntitySpottedState_t - duvar kontrolü için
		inline std::ptrdiff_t m_iShotsFired = 0x0; // RCS için - kaç atış yapıldı
	}
}
