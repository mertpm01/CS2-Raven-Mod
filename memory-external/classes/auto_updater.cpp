...
namespace updater {
	...
	bool read() {
		...
		if (data["m_entitySpottedState"].is_number())
			offsets::m_entitySpottedState = data["m_entitySpottedState"];
		if (data["m_iShotsFired"].is_number())
			offsets::m_iShotsFired = data["m_iShotsFired"];
	...
	void save() {
		...
		data["m_entitySpottedState"] = offsets::m_entitySpottedState;
		data["m_iShotsFired"] = offsets::m_iShotsFired;
